            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        ...
                        <a href="index.php?uc=statAnneeFraisFor&action=selectionnerAnneeFraisFor" class="btn btn-primary btn-lg" role="button"><span class="glyphicon glyphicon-list-alt"></span> <br/>Frais remboursé par années et catégories</a>
